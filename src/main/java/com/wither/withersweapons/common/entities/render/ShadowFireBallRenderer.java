...
@OnlyIn(Dist.CLIENT)
public class ShadowFireBallRenderer extends EntityRenderer<ShadowFireBall> {
   private static final ResourceLocation SHADOW_LOCATION = new ResourceLocation("withersweapons:textures/entity/shadow_fire_ball.png");
   private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(SHADOW_LOCATION);

   public ShadowFireBallRenderer(EntityRendererProvider.Context p_173962_) {
      super(p_173962_);
   }

   protected int getBlockLightLevel(ShadowFireBall p_114087_, BlockPos p_114088_) {
      return 7;
   }

   public void render(ShadowFireBall p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
      p_114083_.pushPose();
   ...
   public ResourceLocation getTextureLocation(ShadowFireBall p_114078_) {
